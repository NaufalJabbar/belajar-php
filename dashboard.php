...
$products = array(
    array(
        ...
        'image' => 'dist/img/prod-1.jpg',
        'price' => '100',
    ),
    array(
        'name' => 'Produk 2',
        'description' => 'Deskripsi produk 2',
        'image' => 'dist/img/prod-2.jpg',
        'price' => '152',
    ),
    array(
        'name' => 'Produk 3',
        'description' => 'Deskripsi produk 2',
        'image' => 'dist/img/prod-3.jpg',
        'price' => '120',
    ),
    array(
        'name' => 'Produk 4',
        'description' => 'Deskripsi produk 2',
        'image' => 'dist/img/prod-4.jpg',
        'price' => '110',
    ),
    array(
        'name' => 'Produk 5',
        'description' => 'Deskripsi produk 2',
        'image' => 'dist/img/prod-5.jpg',
        'price' => '115',
    ),
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
          ...
          <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
              <a href="#" class="d-block">M.Naufal Jabbar Rasyiq</a>
            </div>
          </div>
